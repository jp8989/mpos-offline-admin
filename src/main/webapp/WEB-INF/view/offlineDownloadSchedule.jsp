...
<nav class="w3-sidebar w3-bar-block w3-collapse w3-large w3-theme-l5 w3-animate-left" id="mySidebar">
  ...
  <a class="w3-bar-item w3-button w3-hover-black" href="${messageUrl}">Offline Device Reports</a>
  
  	<c:url value="/offlineDownloadSchedule" var="messageUrl" />
  <a style="color:teal" class="w3-bar-item w3-button w3-hover-black" href="${messageUrl}">Offline Download Schedule</a>
